...
function Expense() {
  ...
  const handleAddExpense = async (expense) => {
    ...
    try {
      ...
      console.error("Error adding in Expense" , error.response?.data?.message || error.message)
    }
  ...
  const handleDownloadExpenseDetails = async () => {
    try {
      ...
      toast.error("Error downloading Expense details : ", error.response?.data?.message || error.message)
    }
  }
